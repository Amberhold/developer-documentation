...
- [ADR-0005](adr/0005-identity-model-separate-nas-db.md) — identity model (separate NAS DB with optional system/SMB link)
- [ADR-0006](adr/0006-updates-as-a-product-feature.md) — updates as a product feature
...
- [ADR-0008](adr/0008-prometheus-metrics-for-every-subsystem.md) — Prometheus metrics for every subsystem
- [ADR-0009](adr/0009-nfs-share-management-via-zfs-sharenfs.md) — NFS share management via ZFS `sharenfs` properties
- [ADR-0010](adr/0010-supported-multi-protocol-access-combos.md) — supported multi-protocol concurrent access combos
