...
| 8 | Web-UI | Management console over the API; no direct host access. Status: scaffold + resource-screen framework landed; Identity group (users, roles, sessions, tokens) live with descriptor-driven screens and contract-generated spec forms; remaining groups follow — see `docs/architecture/14-web-ui.md` (D-W18), ADR-0033 |
...
| Web-UI resource screens | Descriptor registry drives navigation, generated routes, list/detail screens, and operation+capability-gated affordances; contract-generated spec forms with a full-fidelity YAML/JSON escape hatch; Identity group first | [14-web-ui](architecture/14-web-ui.md) (D-W18) |
